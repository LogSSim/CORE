...
CONFIG_NAME="mp_terminal_goal_v2_stage"
TASK_NAME="adroit_hammer"
GPU_ID="0"
SEED="0"
RUN_ROOT="${PROJECT_DIR}/data/outputs"
GOAL_BANK_ROOT="${PROJECT_DIR}/data/goal_bank_mp_v2"
STAGE1_NUM="20"
STAGE3_NUM="10"
TERMINAL_WINDOW="8"
NUM_CLUSTERS="4"
...
Options:
  ...
  -c, --config NAME               Hydra config, default: ${CONFIG_NAME}
      ...
      --goal-selection MODE       fixed | common | soft_nearest, default: ${GOAL_SELECTION}
...
case "${STAGE}" in
  ...
  stage2|2)
    ...
    python "${PROJECT_DIR}/scripts/build_mp_terminal_goal_v2_bank.py" \
