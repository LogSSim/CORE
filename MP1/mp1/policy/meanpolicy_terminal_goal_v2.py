"""MeanPolicy terminal-goal v2.

This policy keeps the MeanFlow/MP training objective from Meanpolicy and adds
the terminal-goal v2 conditioning used by the DP3 v2 variant. It is a separate
entry point so existing MP and DP3 methods are unaffected.
"""
...
class MeanpolicyTerminalGoalV2(TerminalAuxMixin, Meanpolicy):
    def __init__(
        self,
        *args,
        terminal_aux=None,
        ...
        **kwargs,
        ...
        if self.goal_feature_dim % 2 != 0:
            raise ValueError("MeanpolicyTerminalGoalV2 requires an even goal_feature_dim.")
        ...
        cprint(
            f"[MP-TerminalGoalV2] terminal_aux={self.use_terminal_aux}, "
    ...
    def load_terminal_encoder_checkpoint(self, checkpoint_path):
        ...
        cprint(
            f"[MP-TerminalGoalV2] loaded terminal encoder {path}, "
