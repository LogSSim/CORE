...
class TerminalAuxMixin:
    """Auxiliary terminal representation losses shared by MP and MP1 variants."""
    ...
    def _terminal_aux_loss(self, batch: Dict[str, torch.Tensor]):
        ...
        aux_loss = (
            ...
            + self.lambda_ttg * loss_ttg
            + self.lambda_term * loss_term
        )
...
class MeanpolicyTerm(TerminalAuxMixin, Meanpolicy):
    """MP policy with terminal representation auxiliary training.

    predict_action and set_normalizer are inherited unchanged from Meanpolicy.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._init_terminal_aux(
            ...
            lambda_ttg=lambda_ttg,
            lambda_term=lambda_term,
            nce_tau=nce_tau,
            term_feat_dim=term_feat_dim,
            term_proj_dim=term_proj_dim,
        )

    def compute_loss(self, batch):
        base_loss, loss_dict = super().compute_loss(batch)
