"""RoboTwin-style DP3 with terminal auxiliary learning and goal prototypes."""
...
class DP3TerminalGoalPolicy(BasePolicy):
    def __init__(
        self,
        shape_meta: dict,
        noise_scheduler,
        ...
        **kwargs,
        ...
        if not obs_as_global_cond:
            raise ValueError("DP3TerminalGoalPolicy requires obs_as_global_cond=True.")
        ...
        cprint(
            f"[DP3-TerminalGoal] terminal_aux={self.use_terminal_aux}, "
    ...
    def load_terminal_encoder_checkpoint(self, checkpoint_path):
        ...
        cprint(
            f"[DP3-TerminalGoal] loaded terminal encoder {path}, "
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        global_cond = self._apply_goal_conditioning(global_cond, nobs)
