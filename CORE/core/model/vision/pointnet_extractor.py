...
class COREPointNetEncoder(nn.Module):
    ...
    def __init__(
        ...
        cprint(f"[COREPointNetEncoder] point cloud shape: {self.point_cloud_shape}", "yellow")
        cprint(f"[COREPointNetEncoder] state shape: {self.state_shape}", "yellow")
        cprint(f"[COREPointNetEncoder] imagination point shape: {self.imagination_shape}", "yellow")
        cprint(f"[COREPointNetEncoder] rgb image shape: {self.rgb_shape}", "yellow")
        ...
        cprint(f"[COREPointNetEncoder] output dim: {self.n_output_channels}", "red")
